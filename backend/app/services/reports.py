...
if __name__ == "__main__":
    ...
    sample_results = [
        DetectionResult(
            ...
            is_duplicate=True,
            similarity_scores={"levenshtein": 0.94, "jaccard": 1.0, "cosine": 0.97},
            source="Samsung Galxy S23 Ultra 256GB",
            risk_level="high",
            detection_method="fuzzy",
            notes="Likely typo in source listing",
        ),
        DetectionResult(
            text="iPhone 15 Pro Max 512GB",
            is_duplicate=False,
            similarity_scores={"levenshtein": 0.32, "jaccard": 0.25, "cosine": 0.41},
            source=None,
            risk_level="none",
        ...
        DetectionResult(
            ...
            is_duplicate=True,
            similarity_scores={"cosine": 0.88},
            source="A fast brown fox leaps over the lazy dog",
            risk_level="medium",
            detection_method="semantic",
            notes="Paraphrase detected",
        ),
        DetectionResult(
            text="Python is a programming language",
            is_duplicate=True,
            similarity_scores={"sha256": 1.0},
        ...
        DetectionResult(
            ...
            is_duplicate=False,
            similarity_scores={"levenshtein": 0.45, "cosine": 0.52},
            source=None,
            risk_level="low",
            detection_method="fuzzy",
        ),
    ...
    path = generate_report(sample_results, output_path="demo_report.xlsx")
    print(f"\n✅ Report saved to: {path}")

    report_bytes = generate_report_bytes(sample_results)
    print(f"✅ Report bytes generated: {len(report_bytes):,} bytes")
